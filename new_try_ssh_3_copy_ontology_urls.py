...
query_ontology = """
  ...
  FROM <https://github.com/shamilasudalshana/demo_repo/blob/main/nf4di_earth_onthology.ttl>
  FROM <https://github.com/shamilasudalshana/demo_repo/blob/main/nf4di_earth_onthology_2.ttl>
  WHERE {
    ?s ?p ?o
  }
"""
